...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create.create': {
    roles: ['business-owner', 'admin-user', 'passenger', 'driver', 'customer-support'],
    key: 'booking',
    tenantPath: [],
    userPath: [],
  },
  ...
  'complaint.create.create': {
    roles: ['business-owner', 'admin-user', 'customer-support'],
    key: 'complaint',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['business-owner', 'admin-user', 'passenger', 'driver', 'customer-support'];
