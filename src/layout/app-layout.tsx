...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'admin-user', 'passenger', 'driver', 'customer-support'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Rides', path: '/rides', entity: 'ride', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
