            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('ride', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/rides/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Start Location" text={data?.start_location} />

                <FormListItem label="End Location" text={data?.end_location} />
                ...
                <FormListItem label="Seats Available" text={data?.seats_available} />
