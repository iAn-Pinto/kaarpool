...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`KaarPool`}</title>

        <meta
          name="description"
          content="Experience KaarPool - India's Premier Car Pool Application. Transforming Your Daily Commute, One Ride at a Time. Similar to BlaBlaCar, but Uniquely Indian."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1636935529049-2078e9ee3e6c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXJwb29sfGVufDB8fHx8MTY5NjMxNzY4OHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@pkprasad1996?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Prasad Panchakshari`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience KaarPool - India's Premier Car Pool Application. Transforming Your Daily Commute, One Ride at a Time. Similar to BlaBlaCar, but Uniquely Indian.`}
            </Text>
            <Box
